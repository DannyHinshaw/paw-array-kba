IDENTIFIER=com.dannyhinshaw.PawExtensions.ArrayKBA
# Target for installation
INSTALL_DIR=$(HOME)/Library/Containers/com.array.Paw/Data/Library/Application Support/com.array.Paw/Extensions/$(IDENTIFIER)
# Source directories
SRC_DIR=./src
# Source files
...
ArrayKBA.zip: $(SRC_BUNDLE)
	mv $(OUT_DIR) $(IDENTIFIER)
	zip -r ArrayKBA.zip "$(IDENTIFIER)/"
	mv $(IDENTIFIER) $(OUT_DIR)

archive: ArrayKBA.zip
